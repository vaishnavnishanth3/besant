...
public class User_methods extends Login_signup
{
    ...
    {
        String query, query1, query2, query3, orderitem, productid;
        ...
        try (Scanner sc = new Scanner(System.in))
        {
            ...
            if (rs1.next())
            {
                ...
                query2 = "SELECT * FROM  product_info WHERE `Product Name` = '"+orderitem+"'";   
                ...
                System.out.println("Cost of Each Product: Rs. "+rs2.getString(4)+"/-");
                System.out.println("Precision Rate: "+rs2.getString(7)+" %");
                ...
                query3 =  "INSERT INTO customer_order_info (`Customer Username`,`Order Date`,`Product ID`,Quantity,`Cost of Order`,`Payment Status`) Values ('"+username+"','"+ordertime+"','"+productid+"','"+quantity+"','"+totalcost+"','Pending');";
