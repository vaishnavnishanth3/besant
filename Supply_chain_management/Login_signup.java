...
public class Login_signup
{
    ...
    public static void signup() throws ClassNotFoundException, SQLException 
    {
        try (Scanner sc = new Scanner (System.in))
        {
            String user_name, user_username, user_password, user_email, query1; boolean exists; long user_mobile;
            ...
            user_mobile = user_mobile.subLong(10,10)

            if (user_mobile == false)
            {
            ...
            try 
            {
                ...
                query1 = "INSERT INTO user_info (Name,Username,Password,Email,Mobile) VALUES('"+user_name+"','"+user_username+"','"+user_password+"','"+user_email+"','"+user_mobile+"');";
                
                int rs1 = st.executeUpdate(query1);
                System.out.print("\n"+rs1+ " Data registered Successfully!!\n");
                intro();
            }
    ...
    public static boolean check_username(String user_username) throws ClassNotFoundException, SQLException
    {
        ...
        ResultSet rsu = st.executeQuery(query);
    ...
    public static void login() throws ClassNotFoundException, SQLException
    {
        try (Scanner sc = new Scanner (System.in))
        {
            String login_password,user_dbpassword,user_dbname,query2; int i;
            ...
            {
                query2 = "SELECT * FROM admin_info WHERE `Admin ID` = '"+username+"'";
            }

            else
            {
                query2 = "SELECT * FROM user_info WHERE `Username` = '"+username+"'";
            }
            ...
            if (rs2.next())
            {
                user_dbpassword = rs2.getString(4);
                user_dbname = rs2.getString(3);
